                    ...
                    <div className="col-lg-6" data-aos="fade-up">
                        ...
                        <div className="resume-item pb-0">
                            ...
                            <ul>
                                ...
                                <li>+91-9306240152</li>
                                <li>sunderjangra789@gmail.com</li>
                            </ul>
                        </div>
                        ...
                        <div className="resume-item">
                            <h4>Diploma</h4>
                            <h5>2010 - 2013</h5><br />
                            <h5>Percentage:- 57.88%</h5>
                            <p><em>Govt. Polytechnic Hisar, Haryana</em></p>
                        </div>
                        <div className="resume-item">
                            <h4>10<span>TH</span></h4>
                            <h5>2008 - 2009</h5> <br />
                            <h5>Percentage:- 66.6%</h5>
                            <p><em>H.T.M High School, Hisar, Haryana</em></p>
                        </div>
                    </div>
