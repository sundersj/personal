...
const SectionSkills = () =>
{
    ...
    const [skills, setSkills] = useState([
        ...
        { name: 'JQUERY', per: 80, type: 'frontend' },
        { name: 'REACT', per: 75, type: 'frontend' },
        { name: 'BOOTSTRAP', per: 80, type: 'frontend' },
        { name: 'FIGMA', per: 70, type: 'frontend' },
        { name: 'PHP', per: 85, type: 'backend' },
        { name: 'MYSQL', per: 85, type: 'backend' },
        { name: 'OOP', per: 80, type: 'backend' },
        { name: 'GIT', per: 80, type: 'backend' },
        { name: 'BITBUCKET', per: 80, type: 'backend' },
        { name: 'SQL', per: 80, type: 'backend' },
        { name: 'LINUX', per: 75, type: 'backend' },
